...
public class Main extends Application {
    ...
    public void start(Stage stage) throws Exception {
      ...
      /*  for (int i = 0; i < 6; i++) {
        ...
        // Config Buttons //
        Button button1 = new Button("Wind1");
        Button button2 = new Button("Wind2");
        Button button3 = new Button("Wind3");
                ...
                delButton.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        if (textFields.size() > 0) {
                            ...
                            vboxTF.getChildren().remove(vboxTF.getChildren().size() - 1);
                        }
                        }
                });

                root3.getChildren().addAll(addButton, delButton);
                Scene scene3 = new Scene(root3,150.0, 50.0);
